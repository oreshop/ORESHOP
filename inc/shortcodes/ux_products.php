							...
							<div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
								<?php
									...
									do_action( 'woocommerce_after_shop_loop_item_title' );
										////////// AFFICHAGE DU CHAMP INFOSUP1 ////////////////
										$post_meta_array = get_post_meta($product->get_id(), 'infosup1');
										$nb_infos = count($post_meta_array);
										if ($nb_infos >= 1) {
										echo '<br><div class="infosup1">';
										echo get_post_meta($product->get_id(), 'infosup1', true);
										echo '</div>';
										}
